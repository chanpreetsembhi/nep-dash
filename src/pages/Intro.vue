  ...
  <section class="flex items-center justify-center h-svh">
    <div class="mx-auto max-w-2xl">
      ...
      <div class="text-center p-5 sm:mt-3">
        ...
        <p class="mt-5 text-base font-medium text-pretty text-gray-500 sm:text-lg/8">
          Explore student-friendly docs designed to simplify complex topics. From English literature
          to NEP concepts, learn smarter with quick summaries and key points.
        </p>
        <div class="mt-10">
          <RouterLink
            to="/dashboard"
